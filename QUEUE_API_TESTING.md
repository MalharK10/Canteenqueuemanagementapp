...
### Prerequisites
- Backend running on `http://98.93.220.96:5000`
- Frontend running on `http://98.93.220.96:5173` (or appropriate port)
...
**Request:**
```bash
curl -X POST http://98.93.220.96:5000/api/orders \
...
**Request:**
```bash
curl http://98.93.220.96:5000/api/orders \
  -H "Cookie: <your_auth_cookie>"
```
...
**Request:**
```bash
curl http://98.93.220.96:5000/api/orders/queue/info \
  -H "Cookie: <your_auth_cookie>"
```
...
**Request:**
```bash
curl http://98.93.220.96:5000/api/orders/queue/all \
  -H "Cookie: <your_auth_cookie>"
```
...
**Request:**
```bash
curl http://98.93.220.96:5000/api/orders/queue/position \
  -H "Cookie: <your_auth_cookie>"
```
...
**Request:**
```bash
curl http://98.93.220.96:5000/api/orders/507f1f77bcf86cd799439011 \
  -H "Cookie: <your_auth_cookie>"
```
...
**Request:**
```bash
curl -X PATCH http://98.93.220.96:5000/api/orders/507f1f77bcf86cd799439011/status \
  -H "Content-Type: application/json" \
  -H "Cookie: <your_auth_cookie>" \
  -d '{
    "status": "preparing"
...
```
BACKEND_URL=http://98.93.220.96:5000
FRONTEND_URL=http://98.93.220.96:5173
```
